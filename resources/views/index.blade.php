...
<body class="text-gray-700 bg-white" style="font-family:'Source Sans Pro', sans-serif">
        ...
        <div class="container mx-auto px-6 py-2 flex justify-between items-center">
            ...
            <div class="hidden lg:block">
                <ul class="inline-flex">
                    <li><a class="px-4 font-bold" href="{{ asset('home') }}">Home</a></li>
    ...
    <div class="py-20" style="background: linear-gradient(90deg, #667eea 0%, #764ba2 100%)">
        <div class="container mx-auto px-6">
            ...
            <button class="bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider">Pre Order</button>
        </div>
    </div>
    <section class="container mx-auto px-6 p-10">
        ...
        <div class="flex items-center flex-wrap mb-20">
            ...
            <div class="w-full md:w-1/2">
                <img src="{{ asset('img/health.svg') }}" alt="Monitoring">
            </div>
        </div>
        <div class="flex items-center flex-wrap mb-20">
            <div class="w-full md:w-1/2">
                <img src="{{ asset('img/report.svg') }}" alt="Reporting">
            </div>
        ...
        <div class="flex items-center flex-wrap mb-20">
            ...
            <div class="w-full md:w-1/2">
                <img src="{{ asset('img/sync.svg') }}" alt="Syncing">
            </div>
        </div>
    </section>
    ...
    <section style="background-color: #667eea">
        <div class="container mx-auto px-6 text-center py-20">
            ...
            <button class="bg-white font-bold rounded-full mt-6 py-4 px-8 shadow-lg uppercase tracking-wider">Pre Order</button>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6 pt-10 pb-6">
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/4 text-center md:text-left">
                    ...
                    <ul class="mb-4">
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">FAQ</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Help</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Support</a>
                        </li>
                    </ul>
                </div>
                <div class="w-full md:w-1/4 text-center md:text-left">
                    ...
                    <ul class="mb-4">
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Terms</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Privacy</a>
                        </li>
                    </ul>
                </div>
                <div class="w-full md:w-1/4 text-center md:text-left">
                    ...
                    <ul class="mb-4">
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Facebook</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Linkedin</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Twitter</a>
                        </li>
                    </ul>
                </div>
                <div class="w-full md:w-1/4 text-center md:text-left">
                    ...
                    <ul class="mb-4">
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Official Blog</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">About Us</a>
                        </li>
                        <li class="mt-2">
                            <a href="#" class="hover:underline text-gray-600 hover:text-blue-500">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
